...
Class Users extends DBConnection {
	...
	public function load_customers(){
        ...
        public function load_customerss(){
		$qry = $this->conn->query("SELECT *,concat(firstname,' ',lastname) as name FROM `zentries_customers` order by concat(firstname,' ',lastname) asc");
		$data = array();
			while($row = $qry->fetch_assoc()){
				$row['avatar'] = validate_image($row['avatar']);
				$data[] = $row;

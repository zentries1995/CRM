...
if(!defined('base_url')) define('base_url','https://zentries.com/crm/');
if(!defined('base_app')) define('base_app', str_replace('\\','/',__DIR__).'/' );
if(!defined('dev_data')) define('dev_data',$dev_data);
if(!defined('DB_SERVER')) define('DB_SERVER',"195.250.20.76");
if(!defined('DB_USERNAME')) define('DB_USERNAME',"zentries_root");
if(!defined('DB_PASSWORD')) define('DB_PASSWORD',"K3hfpUG1Aur$");
if(!defined('DB_NAME')) define('DB_NAME',"zentries_live");
?>